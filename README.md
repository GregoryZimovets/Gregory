...
|:-------|:---------|:----|:----|
|[Выявление определяющих успешность игры закономерностей](https://github.com/GregoryZimovets/Gregory/blob/main/ПроектАнализДанныхИгры.ipynb)| В данном проекте я приоритизировал гипотезы, запустил A/B-тест и проанализирровал результаты. |python, pandas, numpy, matplotlib, scipy|Завершен|
